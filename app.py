...
=======
    try:
        ...
        chrome_options.add_argument("--no-sandbox")
        chrome_options.add_argument("--disable-dev-shm-usage")
>>>>>>> a583bfb113d17bf48370dd7bec8be1446042b478
    ...
    for job in job_items:
        ...
        rel_value = job.get("rel")  # Example: tab_1_1

        # Match the correct tab_content div based on class name match
        job_detail_div = None
        ...
        if not job_detail_div:
            continue  # Skip if matching detail not found
        ...
        # Extract experience, location, vacancies, qualification
